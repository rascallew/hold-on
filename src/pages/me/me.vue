...
export default {
  ...
  methods: {
    rankArray() {
      ...
      var quotes = ["不奋发，则心日颓靡；不检束，则心日恣肆",
        "自制是一种秩序，一种对于快乐与欲望的控制",
        '哪怕一点小小的克制，也会使人变得强而有力','做一个自律的人，像优秀的人学习，然后做好自己',
        '真正的自由是在所有时候都能控制自己','每天爱自己多一点！！！',' 每天爱自己多一点！！！',
        '如果连自己都不能控制，有什么资格去谈自己想要的','登峰造极的成就源于自律',
        '自我控制是最强者的本能','立志言为本，修身行乃先']
